...
async function main() {
    ...
    */
    ...
    // 进行内容替换，默认开启9221调试端口
    fileContent = fileContent.replace(/this.remoteDebugPort=e.remoteDebugPort/g, 'this.remoteDebugPort=9221');
    // 进行内容替换，设置分身浏览器窗口大小
    fileContent = fileContent.replace(/this.windowSize=e.windowSize/g, 'this.windowSize="1920,1080"');
    // 写入替换后的内容到main.js文件
